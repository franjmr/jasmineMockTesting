...
meta4.cont_appraisal.cont_appraisal_ess= ( function() {
        ...
        function finishAction_Automation(pos){
            if(!pos){
                return;
        ...
        /**
         * Get show values from value items
         * @param {Array} valuesItems 
         * @returns {{showEdit:number, showDelete:number, showbtnAddFeedback:number, showCancel:number , showFinish:number, showAsk:number}} showValues 
         */
        function getShowValues_Automation(valuesItems){
        ...
        /**
         * 
         * @param {Number} m4NodeCurrent 
         * @param {{showEdit:number, showDelete:number, showbtnAddFeedback:number, showCancel:number , showFinish:number, showAsk:number}} showValues 
         * @returns {Array} Created buttons
         */
        function createButtonsActions_Automation(m4NodeCurrent, showValues){
			var actions = [];
        ...
        /**
         * Add each action from array into meta4.widget.GroupedActions
         * @param {Number} m4NodeCurrent 
         * @param {HTMLElement} container 
         * @param {Array} buttonsAction 
         */
        function addButtonActions_Automation(m4NodeCurrent, container, buttonsAction){
            if(!container){
                return;
            }
		...
		function createDataActivity(container) {
            ...
            var showValues = getShowValues_Automation();
			...
			if (idStatus === '01'){
                ...
                var actions = createButtonsActions_Automation(current, showValues);
                addButtonActions_Automation(current, divActions, actions);
			}
		...
		function personClick_Automation () {	
		...
		function _init() {
            ...
            _setM4Object_PlcoCpMtHrRole(new meta4.M4Object(PLCO_CP_MT_HR_ROLE, PLCO_CP_MT_HR_ROLE));
        ...
        __test__only__.createButtonsActions = createButtonsActions_Automation;
        __test__only__.addButtonActions = addButtonActions_Automation;
        __test__only__.finishAction = finishAction_Automation;
        __test__only__.personClick = personClick_Automation;
